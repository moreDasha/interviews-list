  ...
  <app-card>
    ...
    <template #content>
      <div class="inputs-list">
        <app-input-wrap>
          <app-input-icon>
            <i class="pi pi-building-columns" style="color: var(--light-color)"></i>
          </app-input-icon>
          <app-input-text v-model="company" placeholder="Компания" />
        </app-input-wrap>
        <app-input-wrap>
          <app-input-icon>
            <i class="pi pi-paperclip" style="color: var(--light-color)"></i>
          </app-input-icon>
          <app-input-text v-model="vacancyLink" placeholder="Ссылка на вакансию" />
        </app-input-wrap>
        <app-input-wrap>
          <app-input-icon>
            <i class="pi pi-user" style="color: var(--light-color)"></i>
          </app-input-icon>
          <app-input-text v-model="hrName" placeholder="ФИО HR" />
        </app-input-wrap>
        <app-input-wrap>
          <app-input-icon>
            <i class="pi pi-telegram" style="color: var(--light-color)"></i>
          </app-input-icon>
          <app-input-text v-model="telegram" placeholder="Telegram username HR" />
        </app-input-wrap>
        <app-input-wrap>
          <app-input-icon>
            <i class="pi pi-whatsapp" style="color: var(--light-color)"></i>
          </app-input-icon>
          <app-input-text v-model="whatsApp" placeholder="WhatsApp телефон HR" />
        </app-input-wrap>
        <app-input-wrap>
          <app-input-icon>
            <i class="pi pi-phone" style="color: var(--light-color)"></i>
          </app-input-icon>
